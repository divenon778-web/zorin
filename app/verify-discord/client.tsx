    ...
    return (
      <Shell badge="Discord Verify">
        <Card>
          ...
          <a href="http://localhost:3000" style={S.btnGhost}>Go to dashboard</a>
        </Card>
      </Shell>
    );
  }
    ...
    return (
      <Shell badge="Discord Verify">
        <Card>
          ...
          <a href={`http://localhost:3000/login?redirect=${encodeURIComponent(`/verify-discord?code=${code}&discordId=${discordId}`)}`} style={S.btnPrimary}>Sign in to continue</a>
        </Card>
      </Shell>
    );
  }
    ...
    return (
      <Shell badge="Discord Verify">
        <Card>
          ...
          <a href="http://localhost:3000/register" style={S.btnPrimary}>Create an account</a>
          <a href={`http://localhost:3000/login?redirect=${encodeURIComponent(`/verify-discord?code=${code}&discordId=${discordId}`)}`} style={{ ...S.btnGhost, marginTop: 10 }}>Sign in with a different account</a>
        </Card>
      </Shell>
    );
  }
