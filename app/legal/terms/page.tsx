        ...
        <div style={S.outerLayout}>
          ...
          <main style={S.main}>
            ...
            <div style={S.pageHeader}>
              ...
              <p style={S.intro}>
                Please read these Terms carefully before using Zorin AI. By accessing or using
            ...
            <div style={S.content}>
              ...
              <Section id="acceptance" title="1. Acceptance of Terms">
                <P>By accessing and using Zorin AI ("the Service"), operated by Zorin Studios ("we", "us", or "our"), you accept and agree to be bound by these Terms of Service and all applicable laws and regulations. If you do not agree to these terms, you are prohibited from using or accessing this Service.</P>
                <P>These Terms constitute the entire agreement between you and Zorin Studios regarding your use of the Service, and supersede any prior agreements. We reserve the right to modify these terms at any time by posting an updated version. We will notify users of significant changes by updating the "Last updated" date at the top of this page. Your continued use of the Service after any changes constitutes your acceptance of the new terms.</P>
              </Section>

              <Section id="description" title="2. Description of Service">
                <P>Zorin AI is an AI-powered development tool that generates Roblox Luau scripts, systems, UI components, and game instances based on natural language prompts. The Service is accessible through our web dashboard at dash.zorin.lol, our Roblox Studio plugin, and our browser-based chat interface — and is intended for use by Roblox developers of all skill levels.</P>
                <P>The Service connects to your Roblox account via OAuth2, syncs your game's hierarchy from Studio, and delivers generated output directly into your project through the Zorin plugin. Additional features include project management, version history, heartbeat-based session tracking, and collaborative tools. We reserve the right to modify, expand, suspend, or discontinue any feature or the Service in its entirety at any time, with or without notice.</P>
              </Section>

              <Section id="eligibility" title="3. Eligibility">
                <P>You must be at least 13 years of age to use Zorin AI. If you are under the age of majority in your jurisdiction, you represent that your parent or legal guardian has reviewed and agreed to these Terms on your behalf.</P>
              ...
              <Section id="acceptable-use" title="5. Acceptable Use">
                <P>You agree to use Zorin AI only for lawful purposes and in a manner consistent with all applicable laws, regulations, and these Terms. You must not use the Service to:</P>
                <List items={[
                  ...
                  "Resell, sublicense, or commercialize the Service or its outputs without prior written consent from Zorin Studios",
              ...
              <Section id="generated" title="6. Generated Content">
                ...
                <P>Zorin Studios is not responsible for any bugs, errors, security vulnerabilities, performance issues, or unintended behaviors in Generated Content that may affect your games, experiences, or end users. All Generated Content is used at your own risk.</P>
              </Section>

              <Section id="ip" title="7. Intellectual Property">
                <P>The Zorin AI platform — including its web dashboard, Studio plugin, authentication system, APIs, design, source code, branding, logos, and all content created by Zorin Studios — is protected by copyright, trademark, and other applicable intellectual property laws. All rights are reserved by Zorin Studios unless otherwise stated.</P>
              ...
              <Section id="data" title="9. Data & Privacy">
                ...
                <P>When you use the Studio plugin, Zorin AI scans and uploads your game's service hierarchy — including script names, class names, folder structures, and source code — to our servers. This data is used solely to provide context to the AI for better code generation. We do not share this game data with third parties.</P>
                <P>You retain ownership of your prompts, game data, and project inputs. By submitting content, you grant Zorin Studios a limited, non-exclusive, royalty-free license to process your inputs solely for the purpose of delivering and improving the Service. We do not sell your personal data.</P>
              </Section>

              <Section id="third-party" title="10. Third-Party Services">
                <P>The Service integrates with third-party platforms including Roblox (for authentication and avatar data), payment processors (for billing), and infrastructure providers. These services are governed by their own terms and privacy policies, and Zorin Studios is not responsible for their content, availability, or practices.</P>
                <P>The Zorin Studio plugin makes HTTP requests to our API endpoints. Your use of the plugin requires that HTTP Requests are enabled in your Roblox Studio game settings. We are not responsible for network errors, Roblox API changes, or plugin behavior resulting from Roblox platform updates.</P>
              </Section>

              <Section id="plugin" title="11. Studio Plugin">
                <P>The Zorin AI Studio plugin ("the Plugin") is a Roblox Studio tool that connects to our Service, scans your game hierarchy, polls for new generated output, and automatically inserts scripts and instances into your project. The Plugin communicates with our servers at intervals defined by its polling (every 10 seconds), heartbeat (every 15 seconds), and auto-scan (every 60 seconds) cycles.</P>
                <P>By installing and using the Plugin, you acknowledge that it will: (a) send your game's service tree structure and source code to our servers; (b) store a session token in your Studio plugin settings; (c) automatically insert, update, or overwrite scripts and instances in your project when new output is available; and (d) send your Roblox user ID to associate your Studio session with your Zorin account.</P>
                <P>You are responsible for reviewing all code inserted by the Plugin before publishing your experience. Zorin Studios is not liable for any damage, data loss, or policy violations arising from auto-inserted content.</P>
              </Section>
              ...
              <Section id="contact" title="18. Contact">
                ...
                <List items={[
                  ...
                  "Dashboard: Submit a request through the Help & Support section at dash.zorin.lol",
