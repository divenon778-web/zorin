...
const UTM_SOURCES: Record<string, { badge: string; title: string; sub: string }> = {
  "claude.ai":           { badge: "Coming from Claude",   title: "Hey! You found us through Claude.",  sub: "We've got Claude Sonnet 4 built right into Zorin â€” try it on your next Roblox project." },
  "claude":              { badge: "Coming from Claude",   title: "Hey! You found us through Claude.",  sub: "We've got Claude Sonnet 4 built right into Zorin â€” try it on your next Roblox project." },
  "chatgpt.com":         { badge: "Coming from ChatGPT",  title: "Hey! Came over from ChatGPT?",       sub: "Zorin has GPT-5, GPT-4o, O3-Mini and more â€” all purpose-built for Roblox." },
  "chatgpt":             { badge: "Coming from ChatGPT",  title: "Hey! Came over from ChatGPT?",       sub: "Zorin has GPT-5, GPT-4o, O3-Mini and more â€” all purpose-built for Roblox." },
  "grok.com":            { badge: "Coming from Grok",     title: "Hey! Found us via Grok?",            sub: "Grok-4-Fast is one of many models inside Zorin â€” made for Roblox devs." },
  "x.com":               { badge: "Coming from Grok",     title: "Hey! Found us via Grok?",            sub: "Grok-4-Fast is one of many models inside Zorin â€” made for Roblox devs." },
  "grok":                { badge: "Coming from Grok",     title: "Hey! Found us via Grok?",            sub: "Grok-4-Fast is one of many models inside Zorin â€” made for Roblox devs." },
  "gemini.google.com":   { badge: "Coming from Gemini",   title: "Hey! Coming from Gemini?",           sub: "Gemini 2.5 Pro and Gemini 3 Flash are both available in Zorin â€” built for Roblox." },
  "gemini":              { badge: "Coming from Gemini",   title: "Hey! Coming from Gemini?",           sub: "Gemini 2.5 Pro and Gemini 3 Flash are both available in Zorin â€” built for Roblox." },
  "chat.deepseek.com":   { badge: "Coming from DeepSeek", title: "Hey! Came from DeepSeek?",           sub: "DeepSeek V3 and R1 are both inside Zorin â€” wired specifically for Roblox dev." },
  "deepseek.com":        { badge: "Coming from DeepSeek", title: "Hey! Came from DeepSeek?",           sub: "DeepSeek V3 and R1 are both inside Zorin â€” wired specifically for Roblox dev." },
  "deepseek":            { badge: "Coming from DeepSeek", title: "Hey! Came from DeepSeek?",           sub: "DeepSeek V3 and R1 are both inside Zorin â€” wired specifically for Roblox dev." },
  "toolbaz.com":         { badge: "Coming from ToolBaz",  title: "Hey! Coming from ToolBaz?",          sub: "ToolBaz-v4.5-Fast is our default model in Zorin â€” give it a try on Roblox." },
  "toolbaz":             { badge: "Coming from ToolBaz",  title: "Hey! Coming from ToolBaz?",          sub: "ToolBaz-v4.5-Fast is our default model in Zorin â€” give it a try on Roblox." },
};
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{ position: "relative", zIndex: 1, display: "flex", flexDirection: "column", alignItems: "center", textAlign: "center" }}>
            ...
            <Image src={`${CDN}/icons/logo-white.png`} alt="Zorin AI" width={44} height={44} style={{ objectFit: "contain", marginBottom: 20 }} />
            ...
            <a href="http://localhost:3000" className="utm-btn" style={{ display: "inline-flex", alignItems: "center", gap: 7, background: "#fff", color: "#08080e", fontSize: 14, fontWeight: 700, padding: "12px 24px", borderRadius: 10, textDecoration: "none", letterSpacing: "-0.2px", transition: "opacity 0.15s", width: "100%", justifyContent: "center" }}>
              Try it in Zorin
...
const COMP_ROWS = [
  { label: "Works outside Roblox Studio",     zorin: true,  roblox: false },
  { label: "Full multi-script architectures", zorin: true,  roblox: false },
  ...
  return (
    <section style={{ padding: "80px clamp(18px,5vw,24px)", fontFamily: INTER }}>
      <div style={{ maxWidth: 720, margin: "0 auto" }}>
        <h2 style={H2_STYLE}>Why developers choose <span className="grad-text">Zorin.</span></h2>
        <p style={SUB_STYLE}>Roblox Assistant is limited to Studio. Zorin works anywhere, generates complete systems, and produces better code.</p>
        <div style={{ borderRadius: 16, overflow: "hidden", border: "1px solid rgba(255,255,255,0.07)", background: "rgba(255,255,255,0.01)" }}>
          <div style={{ display: "grid", gridTemplateColumns: "1fr 110px 110px", padding: "12px 20px", borderBottom: "1px solid rgba(255,255,255,0.07)", background: "rgba(255,255,255,0.025)" }}>
            ...
            <span style={{ fontSize: 12, fontWeight: 700, color: "#fff", textAlign: "center" }}>Zorin AI</span>
          ...
          {COMP_ROWS.map((row, i) => (
            <div key={i} style={{ display: "grid", gridTemplateColumns: "1fr 110px 110px", padding: "12px 20px", borderBottom: i < COMP_ROWS.length - 1 ? "1px solid rgba(255,255,255,0.04)" : "none", background: i % 2 === 0 ? "transparent" : "rgba(255,255,255,0.01)", alignItems: "center" }}>
              ...
              <span style={{ textAlign: "center" }}><Check yes={row.zorin} /></span>
...
const FAQS = [
  { q: "Why use Zorin instead of Roblox Assistant?", a: "Roblox Assistant is limited to Studio and basic snippet suggestions. Zorin runs anywhere, generates full multi-script systems, and produces typed Luau code that's ready to use in real projects â€” not just quick snippets." },
  { q: "How does Zorin generate code?", a: "You describe the feature you want in plain English. Zorin generates Luau scripts with proper service structure and Roblox-specific conventions built in. The output is designed to land in your project without cleanup." },
  { q: "Do I need to know how to code?", a: "Not at all. Describe what you want â€” a shop system, a leaderboard, a custom character controller â€” and Zorin builds it. If you do know Luau, Fix and Explain modes let you debug and understand existing scripts." },
  { q: "Is there a free plan?", a: "Yes. Sign up and start generating immediately, no credit card needed. Zorin is fully free for every developer right now." },
  { q: "Can I use generated scripts in games I monetize?", a: "Yes. All code generated by Zorin is yours â€” personal projects, commercial games, client work, all of it." },
  { q: "How is this different from just asking ChatGPT?", a: "General-purpose AI tools don't know Roblox's service architecture, instance hierarchy, or Luau conventions. Zorin does. The output is structured for Studio, not adapted from generic programming knowledge." },
];
    ...
    <div style={{ position: "relative", zIndex: 1, minHeight: "100vh", background: "#0a0a0c", fontFamily: INTER, color: "#fff" }}>
      ...
      <section style={{ padding: "0 clamp(18px,5vw,24px) 80px", zIndex: 1, position: "relative" }} className="feature-section-mobile">
        <div style={{ maxWidth: 720, margin: "0 auto", display: "flex", flexDirection: "column", alignItems: "center", textAlign: "center" }}>
          ...
          <p className="anim-fade-up delay-2" style={SUB_STYLE}>Just describe what you need. Zorin handles the rest.</p>
