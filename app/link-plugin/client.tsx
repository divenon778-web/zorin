      ...
      <Shell>
        <Card>
          ...
          {user ? (
            ...
            <a
              href={`https://zorinai.vercel.app/login?redirect=${encodeURIComponent(`/link-plugin?code=${effectiveCode || ""}`)}`}
              style={S.btnPrimary}
            >
              Sign in to continue
            </a>
    ...
    return (
      <Shell>
        <Card video="https://d8j0ntlcm91z4.cloudfront.net/user_38xzZboKViGWJOttwIXH07lWA1P/hf_20260818_072341_50851634-bbc3-4c33-9acc-7647d4db44aa.mp4">
          ...
          <a href="https://zorinai.vercel.app" style={S.btnGhost}>Open dashboard</a>
        </Card>
      </Shell>
    );
  }
