...
const OLLAMA_BASE = "https://api.tokenrouter.com/v1/chat/completions"
const OLLAMA_MODEL = "qwen/qwen3.8-max-free"
const OLLAMA_API_KEY = process.env.TOKENROUTER_API_KEY || ""
...
const STEPS_MODEL    = "qwen/qwen3.8-max-free"
const THINKING_MODEL = "qwen/qwen3.8-max-free"
