...
const OLLAMA_MODEL = "YuriiFominYoung/fable-5"
...
const DEFAULT_MODEL  = "YuriiFominYoung/fable-5"
const STEPS_MODEL    = "YuriiFominYoung/fable-5"
const THINKING_MODEL = "YuriiFominYoung/fable-5"
...
function getProviderConfig(model) {
  return { base: OLLAMA_BASE, provider: "ollama", model: OLLAMA_MODEL, apiKey: OLLAMA_API_KEY }
}
...
export function normaliseResponse(result, model, reasoning = "", fellBack = false, provider = "ollama") {
