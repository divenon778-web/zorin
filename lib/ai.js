...
export function callHcnsecStream(system, messages, model, timeoutMs = 120000) {
  ...
  if (!apiKey) {
    const e = new Error("Missing ORCAROUTER_API_KEY env var")
    e.isAuthError = true
    e.status = 500
...
async function callHcnsec(system, messages, model, timeoutMs = 120000) {
  ...
  if (!apiKey) throw Object.assign(new Error("Missing ORCAROUTER_API_KEY env var"), { isAuthError: true, status: 500 })
